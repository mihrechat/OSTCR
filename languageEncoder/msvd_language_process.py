...
train_data     = '/root/autodl-tmp/CausalSTGNet/datasets/open_ended_vqa/MSVD_vqa/train'
test_data      = '/root/autodl-tmp/CausalSTGNet/datasets/open_ended_vqa/MSVD_vqa/test'
val_data       = '/root/autodl-tmp/CausalSTGNet/datasets/open_ended_vqa/MSVD_vqa/val'
...
# Define the MSVD Question Types
MSVD_QTYPES = {
    'what': 0,
    'who': 1,
    'how': 2,
...
def build_msvd_vocabs_and_priors(train_json, valid_json, test_json, ln_output_dir):
    ...
    for qt_str, count in qtype_counts.items():
        ...
        qtype_expected_embs[idx] = p_t * emb
...
def force_extract_missing():
    ...
    splits = {
        "train": '/root/autodl-tmp/CausalSTGNet/datasets/open_ended_vqa/MSVD/train',
        "val":   '/root/autodl-tmp/CausalSTGNet/datasets/open_ended_vqa/MSVD/val',
        "test":  '/root/autodl-tmp/CausalSTGNet/datasets/open_ended_vqa/MSVD/test'
    }
