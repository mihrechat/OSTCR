...
def improved_track_and_build_scene_graph(
    ...
    for frame_idx, result in enumerate(l_results):
        ...
        for i, (box, raw_id, cls_id, conf, mask_hires) in enumerate(
            ...
            final_id = int(raw_id) if raw_id != -1 else None
...
TRAINI_VIDEO_ROOT =  '/root/autodl-tmp/YouTubeClips'
...
TRAIN_OUTPUT = '/root/autodl-tmp/CausalSTGNet/datasets/multi-choice_vqa/TGIF/trans/test2_masks'
TEST_OUTPUT  = '/root/autodl-tmp/CausalSTGNet/datasets/multi-choice_vqa/TGIF/trans/train2_masks'
...
#     return (
#         os.path.exists(os.path.join(TRAIN_OUTPUT, video_stem + ".json")) or
...
if __name__ == "__main__":
    ...
    TRAIN_VIDEO_ROOT = '/root/autodl-tmp/CausalSTGNet/datasets/multi-choice_vqa/TGIF/trans/trans_test_video'
